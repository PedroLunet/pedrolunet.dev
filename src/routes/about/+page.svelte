	...
	<div class="grid grid-cols-1 gap-16 lg:grid-cols-12">
		<div class="sticky top-24 col-span-1 flex flex-col gap-12 self-start lg:col-span-5">
			<div class="overflow-hidden">
				<h1
					class="reveal-text text-text-primary translate-y-full text-[clamp(3.5rem,14cqi,10rem)] leading-[0.85] font-bold tracking-tighter uppercase opacity-0"
				>
					It's<br />Me.
				</h1>
			</div>
		...
		<div class="col-span-1 flex flex-col lg:col-span-7 lg:pt-8 lg:pl-12">
			<div class="mb-24 flex flex-col gap-8">
				...
				>
					<p>
						My journey didn't start in design—it started in engineering. I spent years understanding
						the architecture of systems before realizing that the most powerful code is the kind
					...
					<p>
						...
						always the same: to make the web feel less like a document and more like a destination.
					</p>
				</div>
			</div>
